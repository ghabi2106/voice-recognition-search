...
`}
          ...
          <article id="detectChanges-markForCheck">
            <h6>4️⃣ detectChanges() vs markForCheck()</h6>
            <div>
              <strong>
...
`}
          ...
          <article id="bypass">
            <h6>bypass Zone.js</h6>
            <div>
              <p>
                You can <strong>bypass Zone.js</strong> using{" "}
                <code>NgZone.runOutsideAngular()</code>, which prevents
                unnecessary change detection:
              </p>
              <Highlight language="ts">{`constructor(private ngZone: NgZone) {}

ngOnInit() {
  this.ngZone.runOutsideAngular(() => {
    setTimeout(() => {
      console.log('Executed outside Angular Zone');
    }, 1000);
  });
}
`}</Highlight>
          ...
          <article id="applicationref">
            <h6>ApplicationRef </h6>
            <div>
              <ul>
                <li>
                  <code>ApplicationRef.tick()</code> manually triggers change
                  detection for the entire app.
                </li>
                <li>
                  Can be useful in cases where Angular doesn’t detect changes
                  (e.g., micro frontends).
                </li>
              </ul>
            </div>
