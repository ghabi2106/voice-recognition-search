        ...
        <section id="dotnet-core">
          ...
          <article id="element">
            ...
            <div>
              <ul>
                <li>
                  Use <code>@angular/elements</code>:
                  <Highlight language="ts">{`const el = createCustomElement(MyComponent, { injector: this.injector });
customElements.define('my-element', el);
`}</Highlight>
                </li>
                <li>This allows the component to be used outside Angular.</li>
              </ul>
            </div>
          </article>
        </section>
