      ...
      <div className="bd-cheatsheet container-fluid bg-body">
        <section id="dotnet-core">
          ...
          <article id="yield">
            <h6>yield</h6>
            <p>
              Utilisez une instruction <code>yield return</code> pour retourner
              chaque élément un par un dans un <code>IEnumerable</code> ou{" "}
              <code>Inumerator</code> en utilisant par exemple <code></code>
              freach
            </p>
          </article>
        </section>
